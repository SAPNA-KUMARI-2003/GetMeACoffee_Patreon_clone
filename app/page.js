  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex gap-6 md:gap-2 md:text-5xl justify-center items-center text-3xl">
          Get Me a Coffee
          <span>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 px-10   ">
        ...
        <div className="flex gap-8 md:gap-5 justify-around flex-col md:flex-row ">
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className=" w-auto border hidden md:block">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/jFNdARDCrKA?si=5FrecgM2h2TpCmel"
        ...
        <div className=" w-auto border block md:hidden">
          <iframe
            src="https://www.youtube.com/embed/jFNdARDCrKA?si=5FrecgM2h2TpCmel"
            title="YouTube video player"
            frameborder="0"
