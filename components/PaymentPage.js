...
const PaymentPage = ({ username }) => {
    ...
    return (
        <>
            ...
            <div className='border bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px]'>

                <div className='cover w-full bg-red-50 relative'>
                    <Image className='object-cover w-full md:h-[350px] shadow-blue-700 shadow-sm' width={1000} height={48} src={currentUser.coverpic || "/creator_home_page.jpg"} alt="" />
                    <div className='absolute -bottom-20 right-[33%] md:right-[46%] border-white overflow-hidden border-2 rounded-full size-36'>
                        <Image className='rounded-full object-cover size-36' width={128} height={128} src={currentUser.profilepic || "/squre-smile.jpg"} alt="" />
                    </div>
                </div>
                            ...
                            <ul className='mx-5 text-lg'>
                                ...
                                {payments.map((p, i) => {
                                    return <li key={i} className='my-4 flex gap-2 items-center'>
                                        <Image width={33} height={33} src="/profile.gif" alt="user avatar" />
                                        <span>
